...
3. Pick 1–5 lowercase-hyphenated tags from the intent + content. Reuse tags already in /home/workspace/vault/tags-index.json where they fit.
4. Call the capture script:
   `echo '<json>' | bun run /home/workspace/vault/scripts/capture.ts`
...
5. Check the capture output for a `pendingAutomation` field. If present:
   ...
   b. Remove the corresponding line from /home/workspace/vault/.pending-automations.jsonl.
...
Do not write outside /home/workspace/vault/. Do not call external services beyond what the capture script does.